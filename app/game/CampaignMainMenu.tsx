...
const place=(checkpoint:CampaignCheckpointView)=>checkpoint.hasActiveHunt?'Chasse suspendue':checkpoint.resumeLocation==='homeworld'?'Yautja Prime':checkpoint.resumeLocation==='new-game'?'Début de campagne':'Vaisseau';
  ...
  <div className={styles.shell} inert={confirmation!==null}>
   ...
   {view==='main'?<div className={styles.landing}><section className={styles.primary} aria-label="Menu principal">
    ...
    {view==='new'?<div className={styles.newGame}>
     <p>Le début actuellement jouable comprend l’identité du chasseur, le briefing de Vey puis la première chasse en jungle. Le prologue de jeunesse de la nurserie reste en production ; aucun rite ne sera validé artificiellement.</p>
