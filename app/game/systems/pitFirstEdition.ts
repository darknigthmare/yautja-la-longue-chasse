...
> = {
  "the-pit": arena("the-pit", "Cercle de basalte", "Système Cinder · annexe orbitale du Cercle", { sky: "#10171a", ground: "#282722", accent: "#c66e3b" }, ["smoke-vault", "clan-pillars", "basalt-ring", "ritual-chain"]),
  ...
  "glass-terrace": arena("glass-terrace", "Terrasse de verre", "Serekh-9 · dunes vitrifiées et pylônes anciens", { sky: "#111c20", ground: "#243238", accent: "#8ad0c5" }, ["vitrified-dunes", "ancient-pylons", "glass-terrace", "reflection-shards"]),
...
export const PIT_CLAN_CIRCUIT_CHAPTERS: readonly PitClanCircuitChapter[] = [
  ...
  },
  {
    ...
    objective: "Éprouver trois styles de maîtrise au fil de trois duels successifs.",
    format: "route",
  ...
  },
  {
    ...
    objective: "Remporter les deux duels de cette chronique de trophées profanés.",
  ...
  },
  {
    ...
    objective: "Remporter quatre duels successifs dans les arènes de la Fosse.",
    format: "survival",
  ...
  },
  {
    ...
    id: "judgment",
    name: "Le Jugement",
    objective: "Vaincre le rival, puis la reconstitution de Warlord au Tribunal des ruines.",
    format: "boss",
