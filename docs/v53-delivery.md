...
La qualification publique est une étape séparée : après le déploiement, les résultats et le SHA réellement servi sont enregistrés dans `outputs/qa-commercial-audit/v53/publication-verified.json`. L'absence de ce rapport ne vaut pas une validation publique.
