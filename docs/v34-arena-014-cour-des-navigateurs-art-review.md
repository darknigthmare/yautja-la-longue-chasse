# Cour des Navigateurs — revue du kit V34
...
Contexte : Place stellaire entourée de balises et cartes holographiques

Direction visuelle : Night navy orbital plaza, deep blue bronze, restrained cyan star-map light, cool polished basalt and dim amber locator lamps.

Quatorze images OpenAI intégrées à la chaîne de production, chacune générée seule et conservée sans retouche de pixels. Les prompts, originaux et SHA complets sont archivés sous art-source/v34/pit-arenas/arena-014-cour-des-navigateurs. Les statuts reviewed concernent ici l'inspection des images individuelles et de leurs fenêtres de rendu ; le kit reste désactivé avant sa recette de composition.

| Plan | Image distincte | Dimensions | Transparence | SHA court |
|---|---|---|---|---|
| P0 | p0-a-depth | 1536×1024 | opaque prévu | 0c8019b190b3 |
| P1 | p1-a-distant-left | 1024×1536 | alpha réel | 7e403c7442f4 |
| P1 | p1-b-distant-right | 1774×887 | alpha réel | 57647621ed05 |
| P2 | p2-a-support-left | 1024×1536 | alpha réel | 9d598e4ecc18 |
| P2 | p2-b-support-right | 1024×1536 | alpha réel | 52bd15b12688 |
| P2 | p2-c-central-structure | 1374×1145 | alpha réel | b7445aad923f |
| P3 | p3-a-prop-left | 1536×1024 | alpha réel | a109a7f40106 |
| P3 | p3-b-prop-right | 1161×1355 | alpha réel | 6c2506bf9d80 |
| P3 | p3-c-light-left | 1024×1536 | alpha réel | 009d2c34b523 |
| P3 | p3-d-light-right | 1024×1536 | alpha réel | 741d27afe227 |
| P4 | p4-a-contact-floor | 2172×724 | alpha réel | 9a56ad9f59a0 |
| P4 | p4-b-front-fascia | 2172×724 | alpha réel | 5ab55062c835 |
| P5 | p5-a-foreground-left | 1024×1536 | alpha réel | 8db54ad48eca |
| P5 | p5-b-foreground-right | 1024×1536 | alpha réel | 757abd2d92a4 |
